...
export default class SearchBox extends Component
{
  ...
  {
    return (
    <div className={this.props.visible?"search":"search hidden"}>
      <button id="btn-search-close" className="btn btn--search-close" >
        <svg className="icon icon--cross">
          <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" />
        </svg>
      </button>
      <form className="search__form" action="" onSubmit={this.handleSubmit}>
        <input id="search-input" className="search__input" name="search" type="search" ref="newQuery" placeholder="Search something..." />
